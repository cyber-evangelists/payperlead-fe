...
export default function ProfileComponent() {
  return (
    <Box w={'80%'}>
      ...
      <Box bgColor={'#FFFFFF'} pt={20} borderTopLeftRadius={'30px'} h={'100vh'}>
        ...
        <Box w={'60%'} bgColor={'#F4F4F4'} borderRadius={'20px'} p={5} mx={'auto'} mt={8}>
        ...
        <Box w={'60%'} bgColor={'#F4F4F4'} borderRadius={'12px'} p={3} mx={'auto'}>
