...
export default function HistoryComponent() {
  return (
    <Box w={'80%'}>
      ...
      <Box bgColor={'#FFFFFF'} p={16} borderTopLeftRadius={'30px'} h={'100vh'}>
        ...
        <Box bgColor={'#FFFFFF'} width={'28%'} height={'60%'} border={'1px solid #EDEDED'} borderRadius={'20px'} display={'flex'} flexDirection={'column'} mt={12}>
